...
- GitHub Release: https://github.com/insightlabs38-pixel/HydroSwarm/releases/tag/v0.1.1-hackathon
- Runtime ZIP: https://github.com/insightlabs38-pixel/HydroSwarm/releases/download/v0.1.1-hackathon/HydroSwarm-v0.1.1-hackathon-runtime.zip
- Release manifest: https://github.com/insightlabs38-pixel/HydroSwarm/releases/download/v0.1.1-hackathon/RELEASE_MANIFEST.json
- Published multiarch image: `ghcr.io/insightlabs38-pixel/hydroswarm:v0.1.1-hackathon`
- Technical report: https://github.com/insightlabs38-pixel/HydroSwarm/blob/v0.1.1-hackathon/docs/FINAL_SYSTEM.md
