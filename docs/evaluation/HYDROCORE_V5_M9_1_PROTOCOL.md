...
## 21. Amendment log (empty at freeze time)

This document is immutable except via a dated, explicit entry in this section. No entries exist as of this document's initial commit.
