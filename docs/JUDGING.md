...
| Exceptionality | A frozen real-compute scenario that contracts uncertainty, rejects an unsafe candidate, verifies an alternative, compares no response, and replays deterministically offline |
